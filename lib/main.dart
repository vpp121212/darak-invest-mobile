...
void main() {
  ...
  // Cairo is bundled locally — never fetch fonts from the network at runtime.
  // This avoids the font-flash (Arabic text briefly rendered with a wrong
  // fallback, e.g. CJK glyphs) on first load / refresh.
