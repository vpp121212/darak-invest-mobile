...
await sql.unsafe(`SET client_min_messages = WARNING;
  ...
  INSERT INTO neighbourhood_pulse (city, district, avg_rent, avg_sale, roi, metro_stations, nearby_projects, sports_boulevard, walk_score, green_spaces, future_value_growth, data_source) VALUES
    ...
    ('الرياض', 'حي النخيل', 52000, 1800000, 6.5, '[]', '[{"name":"المربع الجديد","type":"مشروع ترفيهي","year":2030,"distance":"10 دقائق"}]', false, 60, '[{"name":"حديقة النخيل","distance":"3 دقائق"}]', 14, 'تحليل السوق 2024-2026'),
    ('الرياض', 'العليا', 75000, 3500000, 5.5, '[{"name":"محطة العليا","line":"الأزرق","year":2027,"distance":"2 دقائق"},{"name":"محطة الملك فهد","line":"الأحمر","year":2027,"distance":"5 دقائق"}]', '[{"name":"المربع الجديد","type":"مشروع ترفيهي","year":2030,"distance":"10 دقائق"}]', false, 90, '[{"name":"حديقة العليا","distance":"1 دقيقة"}]', 10, 'تحليل السوق 2024-2026'),
    ('الرياض', 'حي البطحاء', 30000, 1500000, 5.0, '[]', '[]', false, 50, '[]', 3, 'تحليل السوق 2024-2026'),
    ...
    ('الرياض', 'الصحافه', 50000, 1700000, 6.8, '[]', '[{"name":"المربع الجديد","type":"مشروع ترفيهي","year":2030,"distance":"12 دقيقة"}]', false, 58, '[{"name":"حديقة الصحافة","distance":"5 دقائق"}]', 12, 'تحليل السوق 2024-2026'),
